...
(whisperkit or apple), parses the assembled transmissions, computes ATC-normalized token
WER against the exact spoken reference, and records the displayed/filtered classification.
